    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                {{-- agragamos el reply --}}
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="url('reply')" :active="request()->routeIs('reply')">
                        {{ __('Reply') }}
                    </x-nav-link>
                </div>
            </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <div class="ml-1">
                                <svg class="fill-current h-4 w-4" xmlns="https://instructure-uploads.s3.amazonaws.com/account_129840000000000001/attachments/90704/Logo_IUD.png" viewBox="0 0 20 20">
